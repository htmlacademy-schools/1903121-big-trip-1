...
const generateTime = date => {
  ...
  const duration = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getDiffDates)(beginDate, endDate);
  let durationFormat = '';
...
const generateDate = () => {
  const days = 7;
  const daysGap = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, days);
  const daysAddGap = daysGap + (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 2);
  const firstHoursAdd = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(1, 6);
  const lastHoursAdd = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(firstHoursAdd, firstHoursAdd + 10);
  const firstMinutesAdd = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 59);
  const lastMinutesAdd = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(firstMinutesAdd, firstMinutesAdd + 59);
  return {
...
const generateDescription = () => {
  ...
  const descriptionsLength = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(1, descriptions.length);
  let description = '';

  for (let i = 0; i < descriptionsLength; i++) {
    const elementNumber = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, descriptions.length - 1);
...
const generateOffers = () => {
  ...
  const offersCount = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 5);
  const offersList = [];

  for (let i = 0; i < offersCount; i++) {
    const numberElement = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, offers.length - 1);
...
const generatePhoto = () => {
  const photos = [];
  let photoNum = 0;
  const photosCount = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(3, 6);

  for (let i = 0; i < photosCount; i++) {
    photoNum += (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(1, 10);
...
const generateEvents = () => {
  ...
  const price = totalPrice + (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(10, 30);
  const type = types[(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 7)];
  totalPrice = 0;
  return {
    id: (0,nanoid__WEBPACK_IMPORTED_MODULE_2__.nanoid)(),
    date,
    type,
    city: cities[(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 2)],
    time,
    offers,
...
const tripPresenter = new _presenter_trip_presenter_js__WEBPACK_IMPORTED_MODULE_1__["default"](tripEvents, siteNavigationElement, siteFilterElement);
